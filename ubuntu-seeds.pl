...
open MANUAL, '>', "$outdir/manual"
	or die "can't open $outdir/manual for writing: $!\n";
print MANUAL <<EOF or die "can't write to $outdir/manual: $!\n";
Task: manual
Section: special
Relevance: 0
...
Test-Debconf: false
EOF
close MANUAL or die "can't close $outdir/manual: $!\n";
